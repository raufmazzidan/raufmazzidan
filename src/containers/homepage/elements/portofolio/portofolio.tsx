...
const Portofolio = () => {
  return (
    <section className="my-40">
      <div className="max-w-4xl m-auto flex items-center justify-center gap-8 px-8">
        {PORTOFOLIO_DATA.map((porto, i) => (
          <a href={porto.url} key={i}>
            <div className="bg-[#eceff1] hover:bg-[#f6f6f6] hover:scale-[1.02] hover:shadow-portofolio transition ease-out duration-200 rounded-3xl w-full min-h-96 grid grid-cols-2 overflow-hidden">
              <div className="lg:p-16 p-12 lg:!pr-0 lg:col-span-1 col-span-2">
                <Image
                  src={porto.logo.src}
                  alt={porto.logo.alt}
                  height={24}
